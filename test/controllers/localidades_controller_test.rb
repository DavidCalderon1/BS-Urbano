...
class LocalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localidade" do
    assert_difference('Localidade.count') do
      post localidades_url, params: { localidade: { ciudad_id: @localidade.ciudad_id, latitud: @localidade.latitud, longitud: @localidade.longitud, nombre: @localidade.nombre } }
    end
  ...
  test "should update localidade" do
    patch localidade_url(@localidade), params: { localidade: { ciudad_id: @localidade.ciudad_id, latitud: @localidade.latitud, longitud: @localidade.longitud, nombre: @localidade.nombre } }
