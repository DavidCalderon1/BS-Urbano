...
class RutaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rutum" do
    assert_difference('Rutum.count') do
      post ruta_url, params: { rutum: { barrio_id: @rutum.barrio_id, horario: @rutum.horario, operador_id: @rutum.operador_id } }
    end
  ...
  test "should update rutum" do
    patch rutum_url(@rutum), params: { rutum: { barrio_id: @rutum.barrio_id, horario: @rutum.horario, operador_id: @rutum.operador_id } }
