...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { nombre: @estado.nombre, tipoe_id: @estado.tipoe_id } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { nombre: @estado.nombre, tipoe_id: @estado.tipoe_id } }
