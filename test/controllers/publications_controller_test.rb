...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { picture: @publication.picture, state_id: @publication.state_id, user_id: @publication.user_id } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { picture: @publication.picture, state_id: @publication.state_id, user_id: @publication.user_id } }
